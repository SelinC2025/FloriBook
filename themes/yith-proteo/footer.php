...
if ( 'on' !== $hide_footer ) :
	...
	<footer id="main-footer" class="site-footer">
		...
		<div class="site-info">
			<div class="container">
				<?php
				echo do_shortcode( get_theme_mod( 'yith_proteo_footer_credits_content', __( '<a href="http://localhost/floribook/" target="_blank" rel="noopener">FloriBook</a> - A free theme designed with <span class="lnr lnr-heart"></span> by <a href="https://yithemes.com" rel="nofollow">YITH</a>', 'yith-proteo' ) ) );
				?>
			</div>
		</div><!-- .site-info -->
	</footer><!-- #colophon -->
